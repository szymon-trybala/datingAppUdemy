...
namespace DatingApp.API.Data
{
    public class AuthRepository : IAuthRepository
    {
        ...
        public async Task<User> Login(string username, string password)
        {
            ...
            if(!VerifyPasswordHash(password, user.PasswordHash, user.PasswwordSalt))
                return null;
            
            return user;
        }

        private bool VerifyPasswordHash(string password, byte[] passwordHash, byte[] passwwordSalt)
        {
